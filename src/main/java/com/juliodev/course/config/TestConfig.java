...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2024-03-10T13:21:00Z"), u1);
		Order o2 = new Order(null, Instant.parse("2024-03-11T15:53:42Z"), u2);
		Order o3 = new Order(null, Instant.parse("2024-03-16T21:23:37Z"), u1);
